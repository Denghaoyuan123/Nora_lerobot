...
def main():
    ...
    parser.add_argument("--model_path", type=str, 
                        default="/data4/hydeng/nora/lerobot_training/nora_finetune_pick_up_long_0830/hf_model_60000")
    ...
    parser.add_argument("--lerobot_dataset_root", type=str, default="/data4/hydeng/nora/so101_pour_the_tea_ee")
