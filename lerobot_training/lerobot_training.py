...
# from data_helper import patch_lerobot_load_info
...
class TrainingConfig:
    def __init__(
        ...
        output_dir: str = './nora_finetune_object_1',
        pretrained_model_dir: str = '/data4/hydeng/nora/lerobot_training/nora-long/models--declare-lab--nora-long/snapshots/7b0ed6b05a8668638b25a9b33088798c8648464c',
        fast_local_model_path: str = '/data4/hydeng/nora/lerobot_training/fast',
        resume_from_checkpoint: str | None = None, 
        load_model_weights: Optional[str] = None,
        lerobot_dataset_repo_id: str = "xuanyuanj/so101_v3",
        lerobot_dataset_root: str = "/data4/hydeng/nora/lerobot_so101_v3",
        ...
        self.fast_local_model_path = fast_local_model_path
        ...
        # self.image_key = 'observation.images.front'
        self.image_key = 'observation.images.front'
...
def load_and_prepare_dataset(config: TrainingConfig) -> LeRobotDataset:
    ...
    # from data_helper import patch_lerobot_load_info, patch_lerobot_skip_hub
    # patch_lerobot_skip_hub()
    # patch_lerobot_load_info()
    return LeRobotDataset(repo_id = config.lerobot_dataset_repo_id, root = config.lerobot_dataset_root, revision=None)
...
def load_model_and_processor(config: TrainingConfig, accelerator: Accelerator) -> tuple[Qwen2_5_VLForConditionalGeneration, AutoProcessor, AutoProcessor]:
    ...
    local_model_path = config.pretrained_model_dir
    fast_local_model_path = config.fast_local_model_path
